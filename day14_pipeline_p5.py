...
# -----------------------------------------------------------
# COMPATIBILITY DECISION BUILDER
# -----------------------------------------------------------
def build_compatibility_decision(
    ...
    decision = "PASS" if is_allowed else "HARD_FAIL"
...
if __name__ == "__main__":
    ...
    compatibility_decision = build_compatibility_decision(
        expected_version,
        contract_version,
        comparison_result,
        compatibility_mode,
    ...
    if not compatibility_decision["allowed"]:
        terminate_pipeline(
            logger,
            f"COMPATIBILITY FAILURE: {compatibility_decision}",
            2
        )
